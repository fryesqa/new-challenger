...
import { AppRedux, Main, Login, AdminChallenge, ChallengeCreateForm, UserProfile, PlayerList, SubmitAttempt } from '../client/src/components/Components.js';
...
module.exports = (
  <div>
    <Route path="/" component={AppRedux}>
      ...
      <Route path="/challenge/:challengeId" component={PlayerList} />
